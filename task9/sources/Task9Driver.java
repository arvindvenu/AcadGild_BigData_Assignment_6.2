...
/**
 * @author arvind
 * This class is the driver (main class) for Assignment 6.2 task 9. This is the 
 ...
 * input to this job. Also the number of reducers this time will be given via the command line.
 * The command will be run as hadoop jar &lt; jarName &gt; &lt; inputpath &gt; &lt; outputpath &gt; 
 * &lt; numReducers &gt; &lt; min_total_units_sold &gt; &lt; mac_total_units_sold &gt;
 * 
 * The minTotalUntisSold and maxTotalUnitsSold properties are stored in Configuration object. This object 
 * can later be accessed in the mapper to filter out records 
 */
